...
# configurations
img_folder = '/media/himank/SSD/hyperrim_data/lr_images/*.png'  # glob matching pattern
lmdb_save_path = '/media/himank/SSD/hyperrim_data/lr_images/lr.lmdb'  # must end with .lmdb
# img_folder = '/media/himank/SSD/ss_dataset_bbox_r4/img_dir/train/*.png'  # glob matching pattern
# lmdb_save_path = '/media/himank/SSD/ss_dataset_bbox_r4/img_dir/train/HR.lmdb'  # must end with .lmdb
